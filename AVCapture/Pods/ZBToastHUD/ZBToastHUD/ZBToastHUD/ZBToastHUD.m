...
static const CGFloat ZBToastHUDToastDismissDuration = 2.5;
...
{
    [self showWithMessage:message duration:0];
}
...
- (void)showToast
{
    [self showToastWithDuration:0];
}

- (void)showToastWithDuration:(NSTimeInterval)duration
{
    int64_t delta = (int64_t)(ZBToastHUDToastDismissDuration * NSEC_PER_SEC);
    if (duration > 0) {
        delta = (int64_t)(duration * NSEC_PER_SEC);
    }
